...
import {SecondCountryPickerModalContext} from '../screens/Settings'
import countries from "./src/data/countries.json";


export default function SecondCountryPickerView() {

    const {secondCountryModal, setSecondCountryModal, setSelectSecondCountry} = useContext(SecondCountryPickerModalContext);
        ...
        return(
          ...
          <TouchableOpacity
           onPress={ ()=>{
               ...
               setSelectSecondCountry({name, code})
               setSecondCountryModal(!secondCountryModal)}}
          >
      ...
      return (
        <View style={{flex:1, backgroundColor:'#ffffff'}}>
            ...
            <View style={{flex:1, margin:20, flexDirection:'row', justifyContent:'space-between', borderBottomWidth:.2}}>
              ...
              <TouchableOpacity
              onPress={ ()=>   setSecondCountryModal(!secondCountryModal)}
              >
